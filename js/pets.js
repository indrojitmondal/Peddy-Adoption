    ...
    for (const pet of pets) {
      ...
      newDiv.innerHTML = `
        ...
        <div class="pt-5 flex gap-5 justify-center">
         <button class="btn hover:bg-btn like-button"><i class="fa-regular fa-thumbs-up"></i></button>
         <button class="btn hover:bg-btn adopt text-primary">Adopt</button>
         <button class="btn hover:bg-btn details text-primary">Details</button>
        </div>
      `;
